...
import static com.aws.Helper.*;

public class ScaleUpKinesisShards implements RequestHandler<SNSEvent, String>
{
    ...
    public String handleRequest(SNSEvent event, Context context)
    {
        ...
        Double multiplier = Double.valueOf(System.getenv("scale-up-multiplier"));
